...
public class SQLEngine
{
    ...
    const string sql_BD_defoult = "TestBD.db";
    string Puth;
    string NameDB = "Database1.mdf";
    ...
    private void MSConnect()
    {
        ...
        mssql_connect.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Проекты\WinForms\SQliteEngeV2\SQliteEngeV2\Database1.mdf;Integrated Security=True";
        try
        {
            mssql_connect.Open();
        }
